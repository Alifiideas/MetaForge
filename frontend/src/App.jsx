  ...
  return (
    <div className="app">
        ...
        <div className="hero-content">
          ...
          <div className="hero-visual">
            <div className="image-card">
              ...
              <div className="tag delay">business</div>
              <div className="tag delay2">technology</div>
            </div>

            <div className="floating-card">
              <span>Title</span>
              <p>Modern AI Technology Concept</p>
            </div>

            <div className="floating-card delay">
              <span>Keywords</span>
              <p>ai, future, digital, innovation</p>
            </div>

            <div className="floating-card delay2">
              <span>Export</span>
              <p>CSV Ready</p>
            </div>
          </div>
      ...
      <section className="platforms">
        ...
        <div className="platform-grid">
          {[
            ...
            <div key={p} className="platform-card">{p}</div>
          ))}
        </div>
      </section>
      ...
      <section className="how">
        ...
        <div className="steps">
          <Step number="1" title="Upload" desc="Upload images or videos in bulk" />
          <Step number="2" title="Customize" desc="Control metadata using smart sliders" />
          <Step number="3" title="Export" desc="Download ready-to-use CSV files" />
        </div>
      </section>
      ...
      <section className="tools">
        ...
        <div className="tool-grid">
          <Tool title="Duplicate Image Detector" desc="Detect and remove duplicate images" />
          <Tool title="Image Converter" desc="Convert JPG, PNG, WebP & more" />
          <Tool title="Image Upscaler (6×)" desc="Enhance resolution without quality loss" />
          <Tool title="Background Remover" desc="AI-powered background removal" />
        </div>
      </section>
